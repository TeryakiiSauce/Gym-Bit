...
struct DefaultData {
    ...
    static var chestExercises =
        [
            ...
            Exercise(name: "Seated Machine Fly", description: "The chest fly or pec deck is a great way for both beginners and those with experience to target the chest muscles without worrying about the balance required when using a bench, a ball, or when standing. It's also a useful machine if you have a lower-body injury and need to avoid standing.", imagePath: "chest6", tips: ["Lift and lower the weight using slow, controlled movements. If you go too quickly, you will be using momentum rather than training your muscles.","Exhale as your arms bring the handles together in front of your chest and inhale as you return the handles back to the open position."], targetMuscle: Exercise.TargetMuscle.chest.rawValue),
    ...
    static var legExercises =
        [
            ...
            Exercise(name: "Leg Abductor Machine", description: "Machine thigh abductor is a exercise machine exercise that primarily targets the outer thighs.", imagePath: "legs3", tips: ["Hold on to the side grab handles during the execution, fix your upper body and look straight ahead . This prevents the spine from over-rotating.","Make sure that your thighs are parallel to the floor, your back is leaning against the upholstery and forms a light hollow back to relieve your vertebrae. "], targetMuscle: Exercise.TargetMuscle.legs.rawValue),
    ...
    static var absExercises =
        [
            ...
            Exercise(name: "Sit-up", description: "Performing sit ups regularly can help to improve core strength but this does not target fat loss to this body part. One of the many reasons sit ups are ever-popular is that they're easy to modify (e.g. doing them on an incline or while holding weights) so you can continue to challenge yourself as your core strength improves.", imagePath: "abs3", tips: ["To get the most from each sit up perform the exercise slowly or in a controlled manner. This ensures your muscles are working hard and lets you concentrate on your form, which decreases the likelihood of injury.","Don't use your arms to pull up your head as it takes pressure off your core muscles giving them less of a workout and can put additional strain on your neck.", "If you're new to sit-ups, ensure you leave at least one day's rest between ab workouts to give your core time to recover."], targetMuscle: Exercise.TargetMuscle.abs.rawValue),
            
            Exercise(name: "Cable Side Bend", description: "The cable side bend is simply a variation of the side bend typically performed using dumbbells. It’s utilized to build the oblique muscles of the core, which gives the midsection a more aesthetic appearance and helps to create the V-taper look.", imagePath: "abs4", tips: ["Do not move your arm as you bend your body. Grab the handle tightly and lock your shoulder into place.","Do not use momentum to bend. Use your abs and obliques.", "Slowly return your body back to the starting position, using your abs to resist the movement."], targetMuscle: Exercise.TargetMuscle.abs.rawValue),
            
            Exercise(name: "Declined Sit-up", description: "A decline situp bench positions your upper body at an angle so that it’s lower than your hips and thighs. This positioning causes your body to work harder, since you have to work against gravity and through a wider range of motion. Decline situps are an effective core exercise to add to your fitness routine. They improve core strength, prevent injury, and help to stabilize your body.", imagePath: "abs5", tips: ["Cross your arms over your chest, or interlace your fingers around the base of your skull.","Lift your torso up to bring your chest to your thighs, pause here for a few seconds, then return to the starting position."], targetMuscle: Exercise.TargetMuscle.abs.rawValue),
